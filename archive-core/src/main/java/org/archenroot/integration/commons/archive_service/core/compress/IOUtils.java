...
public final class IOUtils {
     ...
     * @throws java.io.IOException when an I/O error occurs during resolving the canonical path of the files
     */
    ...
    /**
     * Makes sure that the given {@link java.io.File} is either a writable directory, or that it does not exist and a directory
     * can be created at its path.
     * <p/>
     * Will throw an exception if the given {@link java.io.File} is actually an existing file, or the directory is not writable
     *
     * @param destination the directory which to ensure its existence for
     * @throws java.io.IOException if an I/O error occurs e.g. when attempting to create the destination directory
